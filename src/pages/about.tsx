...
const About = () => (
  <Main meta={<Meta title="About" description="About Goaloto" />}>
    <Content>
      <p>Goaloto is more than just a website and app. Its a vision, a mission, and a passion. We believe that everyone deserves to live a fulfilling and meaningful life, and that goal setting is the key to unlocking ones true potential.</p>
